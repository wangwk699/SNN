...
SOURCE_CFG="configs/generated/exp1_qwen3_8b_tldr__gif_aware.yaml"
...
# Example:
#   CUDA_VISIBLE_DEVICES=4,5,6,7 ./ann_training/train_and_evaluate_qwen3_8b_gif_aware.sh
...
echo "============================================================"
echo "Qwen3-8B GIF-Aware ANN Training + Evaluation"
echo "============================================================"
...
run_one_learning_rate() {
  ...
  lock_file="/tmp/snn-qwen3-8b-gif-aware-lr-${lock_key}.lock"
  ...
  run_cfg="$(mktemp "/tmp/snn-qwen3-8b-gif-aware-${lock_key}.XXXXXX.yaml")"
