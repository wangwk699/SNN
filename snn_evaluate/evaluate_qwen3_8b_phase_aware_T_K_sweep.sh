...
CFG="${CFG:-configs/generated/exp1_qwen3_8b_tldr__phase_aware.yaml}"
USE_POSTS=(true false)

# CUDA_VISIBLE_DEVICES=0,1 ./snn_evaluate/evaluate_qwen3_8b_phase_aware_T_K_sweep.sh
...
for use_post in "${USE_POSTS[@]}"; do
  override_cfg="$(mktemp /tmp/qwen3_8b_phase_aware_use_post_XXXXXX.yaml)"
